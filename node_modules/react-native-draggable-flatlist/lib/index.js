...
var DraggableFlatList = /** @class */ (function (_super) {
    ...
    function DraggableFlatList(props) {
        ...
        _this.tapGestureHandlerRef = react_1.default.createRef();
        ...
        _this.tapGestureState = new Value(react_native_gesture_handler_1.State.UNDETERMINED);
        _this.isPressedIn = {
            native: new Value(0),
            js: false
        };
        ...
        _this.setCellData = function (key, index) {
            ...
            var cellData = {
                ...
                offset: offset,
                style: style,
                onLayout: function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                ...
                onCellTap: event([
                    {
                        nativeEvent: function (_a) {
                            var state = _a.state, y = _a.y, x = _a.x;
                            return procs_1.getOnCellTap(state, tapState, _this.disabled, offset, _this.scrollOffset, _this.hasMoved, _this.hoverTo, _this.touchCellOffset, _this.onGestureRelease, _this.props.horizontal ? x : y);
                        }
                    }
                ]),
                measurements: {
        ...
        _this.isAtTopEdge = cond(lessOrEq(_this.distToTopEdge, _this.props.autoscrollThreshold), 1, 0);
        _this.isAtBottomEdge = cond(lessOrEq(_this.distToBottomEdge, _this.props.autoscrollThreshold), 1, 0);
        ...
        _this.onContainerTapStateChange = event([
            {
                nativeEvent: function (_a) {
                    var state = _a.state, x = _a.x, y = _a.y;
                    return block([
                        cond(and(neq(state, _this.tapGestureState), not(_this.disabled)), [
                            set(_this.tapGestureState, state),
                            cond(eq(state, react_native_gesture_handler_1.State.BEGAN), [
                                set(_this.isPressedIn.native, 1),
        ...
        _this.onPanStateChange = event([
            {
                nativeEvent: function (_a) {
                    var state = _a.state, x = _a.x, y = _a.y;
                    return block([
                        cond(and(neq(state, _this.panGestureState), not(_this.disabled)), [
        ...
        _this.onPanGestureEvent = event([
            {
                nativeEvent: function (_a) {
                    var x = _a.x, y = _a.y;
                    return block([
                        cond(and(_this.isHovering, eq(_this.panGestureState, react_native_gesture_handler_1.State.ACTIVE), not(_this.disabled)), [
        ...
        _this.runHoverClock = cond(clockRunning(_this.hoverClock), [
        ...
        _this.hoverComponentTranslate = cond(clockRunning(_this.hoverClock), _this.runHoverClock, _this.hoverAnim);
        ...
        _this.CellRendererComponent = function (cellProps) {
            ...
            if (!cellData)
                return null;
            var style = cellData.style, onCellLayout = cellData.onLayout, onCellTap = cellData.onCellTap;
            var ref = _this.cellRefs.get(key);
            if (!ref) {
            ...
            return (react_1.default.createElement(react_native_reanimated_1.default.View, { onLayout: onLayout, style: style },
                react_1.default.createElement(react_native_reanimated_1.default.View, { pointerEvents: activeKey ? "none" : "auto", style: {
                    ...
                    react_1.default.createElement(react_native_gesture_handler_1.TapGestureHandler, { onHandlerStateChange: onCellTap },
    ...
    DraggableFlatList.prototype.render = function () {
        ...
        return (react_1.default.createElement(react_native_gesture_handler_1.TapGestureHandler, { ref: this.tapGestureHandlerRef, onHandlerStateChange: this.onContainerTapStateChange },
            react_1.default.createElement(react_native_reanimated_1.default.View, { style: styles.flex },
                react_1.default.createElement(react_native_gesture_handler_1.PanGestureHandler, __assign({ ref: this.panGestureHandlerRef, onGestureEvent: this.onPanGestureEvent, onHandlerStateChange: this.onPanStateChange }, dynamicProps),
