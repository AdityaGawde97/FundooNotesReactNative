...
import { PanGestureHandler, TapGestureHandler, State as GestureState, TapGestureHandlerGestureEvent } from "react-native-gesture-handler";
...
declare class DraggableFlatList<T> extends React.Component<Props<T>, State> {
    ...
    tapGestureState: Animated.Value<GestureState>;
    isPressedIn: {
    ...
    onContainerTapStateChange: (...args: any[]) => void;
    onPanStateChange: (...args: any[]) => void;
    onPanGestureEvent: (...args: any[]) => void;
    runHoverClock: Animated.Node<number>;
